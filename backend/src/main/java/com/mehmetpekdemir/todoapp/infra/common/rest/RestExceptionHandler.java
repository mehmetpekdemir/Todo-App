...
public class RestExceptionHandler extends BaseController {
    ...
    public Response<?> handleTaskBusinessException(TodoBusinessException taskBusinessException, Locale locale) {
    ...
    public Response<?> handleMethodArgumentNotValidationException(MethodArgumentNotValidException methodArgumentNotValidException) {
